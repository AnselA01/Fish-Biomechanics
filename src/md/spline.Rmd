...
```{r}
#' linear interpolation between two points d2_1 (2nd derivative #1 and #2 where #1 is positive and #2 is negative).  (0 - d2i) / (d2i+1 - d2i) is the relative distance (as a proportion) between d2_1 and d2_2 where d2 is 0

#' The alterative where the mean is taken between strain_i and strain_i+1 incorrectly assumes a uniform change from d2_i to d2_i+1.
