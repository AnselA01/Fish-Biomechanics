...
for (i in 1:nrow(pf09cp01)) {
  ...
  pf09cp01$Derivative[i] <- first_derivative_function(strain_value)  # Compute the derivative
  pf09cp01$SecondDerivative[i] <-second_derivative_function(strain_value)
}
