...
second_deriv_matrix <- dbs(pf09cp01short$Strain, df = 10, derivs = 2)
...
pf10cp01short$first_deriv <- first_deriv_matrix %*% coefs_short[-1]

second_deriv_matrix <- dbs(pf10cp01short$Strain, df = 10, derivs = 2)
pf10cp01short$second_deriv <- second_deriv_matrix %*% coefs_short[-1]
...
pf19 <- area |> filter (Individual == "pf19")
...
pf19mt01short$first_deriv <- first_deriv_matrix %*% coefs_short[-1]

second_deriv_matrix <- dbs(pf19mt01short$Strain, df = 10, derivs = 2)
pf19mt01short$second_deriv <- second_deriv_matrix %*% coefs_short[-1]
