...
#pf15lt01 <- collect(data.generator(data_directory, fish_number = 15, segment = "lt"))[[1]] # i don't know why this one doesn't work. The warnings indicate it found and parsed three files.
