...
#   labs(title = "CP", x = "Fish Length (cm)", y = "Young's Modulus (N/m^2)") +
...
decisions_length |>
  ...
  theme(
    ...
    legend.margin = margin(10, 10, 10, -25),
...
#   geom_point(size = 3, alpha = 0.85, show.legend = FALSE) +
#   geom_line(size = 1, alpha = 0.7, show.legend = FALSE) +
#   labs(title = "MT", x = "Fish Length (cm)", y = "Young's Modulus (N/m^2)") +
#   theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust = 1)) + 
#   scale_y_continuous(breaks = c(0, 250, 500), limits = c(0, 500)) +
#   theme_minimal() + 
...
#   geom_point(size = 3, alpha = 0.85, show.legend = FALSE) +
#   geom_line(size = 1, alpha = 0.7, show.legend = FALSE) +
#   labs(title = "UT", x = "Fish Length (cm)", y = "Young's Modulus (N/m^2)") +
#   theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust = 1)) + 
#   scale_y_continuous(breaks = c(0, 250, 500), limits = c(0, 500)) +
#   theme_mtext(face = "bold"),
#     axis.text.x = element_text(size = 12),
#         axis.title.x = element_text(size = 14),
#         axis.title.y = element_text(size = 14),
#         axis.text.y = el0ement_text(size = 12),
#         plot.margin = margin(0, 145, 5, 0)
#         )
# 
# grid.arrange(p1,p2,p3,p4)
```
